<%-- 
    Document   : Bus
    Created on : 1-Apr-2019, 12:16:31 AM
    Author     : DELL
--%>
...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
    ...
    <div id="p">
        <form action="deleteBus" method="post">
            <p align="center" style="font-family: algerian; font-size: 60px;">Bus Details</p>

            
                <h4>Bus License:</h4><input type="text" name="busLicense" placeholder="Bus no" class="input">
